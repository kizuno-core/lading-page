const features = [
  {
    ...
    description:
      'Taxas menores que as dos concorrentes. Mais da venda fica no seu bolso — e no do seu cliente.',
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description:
      'Crie e gerencie eventos em minutos, sem treinamento. Interface pensada para produtores de todos os tamanhos.',
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    title: 'Rede social do evento',
    description:
      'Compradores podem ver quem mais vai ao evento. Isso gera buzz, aumenta o engajamento e impulsiona vendas orgânicas.',
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    description:
      'Relatórios completos, exportação de base e controle total da sua audiência. Seus dados, sempre.',
  },
]

export function Features() {
  return (
    <section id="features" className="bg-ink-soft px-6 py-24">
      <div className="mx-auto max-w-5xl">
        <div className="mb-16 text-center">
          ...
          <p className="mt-4 text-lg text-gray-500">
            Ferramentas pensadas para gestores de eventos, donos de pubs e promoters.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="rounded-2xl border border-gold/15 bg-ink-muted p-6 transition-colors hover:border-gold/30"
            >
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gold/20 bg-gold/10 text-gold">
                {feature.icon}
              </span>
